...
public:
	...
	//				Instruct the device driver to change the operational mode of the
	//				video engine. 
	virtual __declspec(deprecated("Deprecated. Do not use. Use card properties VIDEO_ENGINE, VIDEO_INPUT_ENGINE and VIDEO_OUTPUT_ENGINE instead."))
	...
	virtual BErr video_capture_compost(unsigned long BufferId) = 0;

	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr set_onboard_keyer(int & On)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr get_onboard_keyer_status(int &On)=0;

	virtual	BErr get_timing_adjust(unsigned int	& HPhase,unsigned int & VPhase,unsigned int & MaxHPhase,unsigned int & MaxVPhase) = 0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr get_letterbox_values(unsigned int&	Lines,int & bBlackEnableFlag)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr get_safearea_info(int&	Title,int& Picture)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int has_downconverter_bnc(int deviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int has_onboard_keyer(int deviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int has_duallink_input(int deviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int has_programmable_colorspace_matrix(int deviceId)=0;
	...
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr Set_DownConverterSignalType(unsigned long type)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr GetDownConverterSignalType(unsigned long & connSignalType)=0;

	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr SetDualLink_Input_Conn_SignalColorSpace(unsigned long  & signalType)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int  GetHDCardType(int nDeviceId)=0;

	// Deprecated Audio Interface 
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr MaxAudioOutBufferSize(long & nSampleCount)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr GetAudioOutBufferFreeSpace(long  & nSampleCount)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr wait_audio_output_interrupt(unsigned long & noQueuedSample,unsigned long & noFreeSample) = 0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr InitAudioPlaybackMode()=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr StartAudioPlayback(int syncCount)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr StopAudioPlayback()=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr WriteAudioSample(int nSampleType,void * pBuffer,long  nNoSample,int bFlag,long nNoSamplesWritten)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr EndAudioPlaybackMode()=0;
