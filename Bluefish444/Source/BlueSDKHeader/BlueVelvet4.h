...
public:
	...
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr SetAnalogCardProperty(int propType,VARIANT & propValue)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr GetAnalogCardProperty(int propType,AnalogPropertyValue & propValue)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr GetAnalogCardProperty(int propType,VARIANT & propValue)=0;

	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr has_analog_connector(int DeviceId) = 0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int has_svideo_input(int DeviceId) = 0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int has_component_input(int DeviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int	has_composite_input(int DeviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int	has_svideo_output(int DeviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int	has_component_output(int DeviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int	has_analog_rgb_output(int DeviceId)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		int	has_composite_output(int DeviceId)=0;

	// Deprecated Audio Input architecture
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr wait_audio_input_interrupt(unsigned long & noQueuedSample,unsigned long & noFreeSample) = 0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr InitAudioCaptureMode()=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr StartAudioCapture(int syncCount)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr StopAudioCapture()=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr ReadAudioSample(int nSampleType,void * pBuffer,long  nNoSample,int bFlag,long nNoSamplesWritten)=0;
	virtual __declspec(deprecated("Deprecated. Do not use."))
		BErr EndAudioCaptureMode()=0;
