...
#define MAX_HANC_BUFFER_SIZE_DWORDS                 (65536)
#define MAX_HANC_BUFFER_SIZE_WITHOUT_HEADER_DWORDS  (65536 - 0x20/4)
#define MAX_HANC_BUFFER_SIZE_BYTES                  (256 * 1024)
#define MAX_HANC_BUFFER_SIZE_UHD_BYTES              (256 * 1024 * 4)
...
struct GenericV210_structure
{
    ...
    BLUE_U32 first_word : 10, second_word : 10, third_word : 10, unused : 2;
#else
    BLUE_U32 unused : 2, third_word : 10, second_word : 10, first_word : 10;
#endif
#ifndef _WIN32
...
struct HancPacketHeaderStruct
{
    ...
    /*  Commonly used  Data ID packet values are
        ...
        This 10 bit word specifies the amount of user data that this hanc will contain. */
#else
...
{
#if defined(__LITTLE_ENDIAN__) || defined(_WIN32) || defined(__linux__)
    BLUE_U32    ZBit : 1,                     /* bit 0    set to declare start of channel status word */
        Channel : 2,                  /* bit 1-2 */
...
union BlueAudioSubFrameHeader
{
    ...
    BLUE_U32  BlueAudioSubFrameWord;
...
struct LTC_TimeCode
{
    ...
    BLUE_U64 unit_frame : 4,
        ...
        binary8 : 4;
#else
    BLUE_U64 binary8 : 4, unsued_3 : 2, ten_hours : 2, binary7 : 4,
...
struct LTC_TimeCode_union
{
    union
    {
        ...
        struct LTC_TimeCode Ltc;
        BLUE_U64 lt_64_value;
        BLUE_U64 Value64;
    };
};
...
{
    BLUE_U8 first_half : 4, second_half : 4;
...
inline BLUE_U64 convert_countto_timecode(BLUE_U32 frame_count, BLUE_U32 framePerSec)
{
    BLUE_U32 frames, second, minutes, hour;
...
inline BLUE_U64 convert_timecode_to_count(BLUE_U64 timecode,
                                          BLUE_U32& frames,
                                          BLUE_U32& second,
                                          BLUE_U32& minutes,
                                          BLUE_U32& hours)
{
    ...
    hours = (BLUE_U32)((BLUE_U32)rp188_timecode.struct_ltc.ten_hours * 10) + (BLUE_U32)rp188_timecode.struct_ltc.unit_hours;
    minutes = (BLUE_U32)((BLUE_U32)rp188_timecode.struct_ltc.ten_minute * 10) + (BLUE_U32)rp188_timecode.struct_ltc.unit_minute;
    second = (BLUE_U32)((BLUE_U32)rp188_timecode.struct_ltc.ten_second * 10) + (BLUE_U32)rp188_timecode.struct_ltc.unit_second;
    frames = (BLUE_U32)((BLUE_U32)rp188_timecode.struct_ltc.ten_frame * 10) + (BLUE_U32)rp188_timecode.struct_ltc.unit_frame;
    return rp188_timecode.ltc;
}
#endif

/* Determine endianess at run-time */
inline BLUE_U32 Int32SwapBigLittle(const BLUE_U32 i)
{
