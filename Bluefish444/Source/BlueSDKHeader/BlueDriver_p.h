/**
 *  @file       BlueDriver_p.h
 *  @brief      Definitions for usage with Bluefish APIs (BlueVelvet and BlueVelvetC)
...
#define CARD_FEATURE_GET_ONBOARD_KEYER_COUNT(value)         ((value >> 20)  & 0xF)
...
#define MISC_CONNECTOR_OUT_SET_SIGNAL_TYPE_LOOP_THROUGH(value)       (value = (value & 0xFFFF0000) | 0x0001)
...
#define MISC_CONNECTOR_OUT_IS_SIGNAL_TYPE_LOOP_THROUGH(value)        (value & 0x0001)
...
/* Error code for BErr */
#define BERR_NO_ERROR                           ( 0)
#define BERR_UNSPECIFIED                        (-1)
#define BERR_TIMEOUT                            (-2)
#define BERR_INVALID_DEVICE_ID                  (-10)
#define BERR_INVALID_VIDEO_CHANNEL              (-11)
#define BERR_INVALID_SDK_INSTANCE               (-12)
#define BERR_INVALID_PARAMETER                  (-13)
#define BERR_INVALID_CONFIG                     (-14)
#define BERR_BUFFER_UNDERRUN                    (-15)
#define BERR_FIFO_NOT_RUNNING                   (-16)
#define BERR_INSUFFICIENT_RESOURCES             (-17)
#define BERR_INVALID_VIDEO_ENGINE               (-18)
#define BERR_CARD_PROPERTY_NOT_SUPPORTED        (-19)
#define BERR_CARD_IN_STANDBY_MODE               (-20)
#define BERR_INVALID_VIDEO_MODE                 (-21)
#define BERR_INVALID_MEMORY_FORMAT              (-22)
#define BERR_INVALID_UPDATE_METHOD              (-23)
#define BERR_INVALID_DATA_RANGE                 (-24)
#define BERR_INVALID_TRANSPORT                  (-25)
#define BERR_INVALID_TRANSPORT_SAMPLING         (-26)
#define BERR_INVALID_TRANSPORT_COLOR_SPACE      (-27)
#define BERR_INVALID_TRANSPORT_COLORIMETRY      (-28)
#define BERR_INVALID_VIDEO_SUB_IMAGE_MAPPING    (-30)
#define BERR_INVALID_SIGNAL_LINK_TYPE           (-31)
...
{
    SCANMODE_INVALID =                                   0,
    SCANMODE_PICTURE_PROGRESSIVE_TRANSPORT_PROGRESSIVE = 1, /* progressive video modes */
    SCANMODE_PICTURE_PROGRESSIVE_TRANSPORT_INTERLACED =  2, /* psf video modes */
    SCANMODE_PICTURE_INTERLACED_TRANSPORT_PROGRESSIVE =  3, /* */
    SCANMODE_PICTURE_INTERLACED_TRANSPORT_INTERLACED =   4, /* interlaced video modes */
    SCANMODE_PROGRESSIVE =                               SCANMODE_PICTURE_PROGRESSIVE_TRANSPORT_PROGRESSIVE,
    SCANMODE_INTERLACED =                                SCANMODE_PICTURE_INTERLACED_TRANSPORT_INTERLACED,
    SCANMODE_PSF =                                       SCANMODE_PICTURE_PROGRESSIVE_TRANSPORT_INTERLACED,
}scan_mode;
...
typedef enum _EBlueCardProperty
{
    ...
    VIDEO_MODE =                                    7,  /**< DEPRECATED; use VIDEO_MODE_EXT_OUTPUT instead */
    ...
    VIDEO_COLOR_MATRIX_MODE =                       25, /**< DEPRECATED */
    ...
    VIDEO_GPIO =                                    29, /**< DEPRECATED */
    VIDEO_PLAYBACK_FIFO_BUFFER_COUNT_QUEUED =       30, /**< This property can be used to retreive how many frames are bufferd/queued in the video playback fifo. */
    VIDEO_PLAYBACK_FIFO_STATUS =                    VIDEO_PLAYBACK_FIFO_BUFFER_COUNT_QUEUED,
    RS422_RX_BUFFER_LENGTH =                        31, /**< DEPRECATED */
    RS422_RX_BUFFER_FLUSH =                         32, /**< DEPRECATED */
    ...
    VIDEO_GENLOCK_SIGNAL =                          35, /**< Use this property to retrieve video signal of the reference source that is used by the card.
                                                            ...
                                                            See application note AN030_Reference.pdf for more information */
    ...
    VIDEO_DUALLINK_OUTPUT_INVERT_KEY_COLOR =        39, /**< DEPRECATED */
    VIDEO_DUALLINK_OUTPUT_DEFAULT_KEY_COLOR =       40, /**< DEPRECATED */
    ...
    VIDEO_PLAYBACK_FIFO_BUFFER_COUNT_FREE =         48, /**< Returns the number of free buffers in the fifo. If the video engine is framestore this will return
                                                             the number of buffers that can be used in framestore mode with that video output channel. */
    VIDEO_PLAYBACK_FIFO_FREE_STATUS =               VIDEO_PLAYBACK_FIFO_BUFFER_COUNT_FREE,
    ...
    VIDEO_SCALER_MODE =                             51, /* DEPRECATED */
    ...
    VIDEO_PREMULTIPLIER =                           60, /**< DEPRECATED */
    ...
    EPOCH_RESET_VIDEO_INPUT_FIELDCOUNT =            75, /**< Use this property to reset the field count on the current input channel. You can pass the value that
                                                             should be used as the starting fieldcount after the reset.
                                                             This property can be used to keep track of sync between multiple linked input channels */
    ...
    VIDEO_PLAYBACK_FIFO_CURRENT_FRAME_UNIQUEID =    80, /**< This property can be used to query the current unique id of
                                                             ...
                                                             property is only valid when the video engine is set to fifo mode.<br/>
                                                             A uniqueid is provided when a frame is presented using the SDK function bfcVideoPlaybackPresent().
                                                             An alternative way to get this information is by calling bfcWaitVideoSync() which will return the unique
                                                             ID in the struct sync_options */
    ...
    EPOCH_ROUTING_SOURCE_VIDEO_MODE =               VIDEO_SCALER_MODE,  /**< DEPRECATED */
    ...
    EPOCH_SCALER_HORIZONTAL_FLIP =                  101,    /**< DEPRECATED */
    EPOCH_CONNECTOR_DIRECTION =                     102,    /**< DEPRECATED */
    ...
    EPOCH_LOW_LATENCY_DMA =                         107,    /**< DEPRECATED */
    ...
    EPOCH_PCIE_CONFIG_INFO =                        118,    /* only supported from driver 5.10.2.x; provides info on PCIE maximum payload size and maximum read request size (see MACROs PCIE_CONFIG_INFO_GET_MAX_***) */
    ...
    INTERLOCK_REFERENCE =                           123,    /* this feature is only supported on Epoch Neutron cards; check application note AN030_Reference.pdf for more information */
    VIDEO_ONBOARD_KEYER =                           124,    /* use the VIDEO_ONBOARD_KEYER_GET_STATUS macros for this property; only supported for Neutron and Kronos cards */
    ...
    BYPASS_RELAY_ENABLE =                           138,    /* Enable/Disable the bypass relays; use MACROs BLUE_ENABLE_BYPASS_RELAY(), BLUE_DISABLE_BYPASS_RELAY() and BLUE_GET_BYPASS_RELAY_SETTING() to initialise the value (.vt = VT_UI4) */
    ...
    SUB_IMAGE_MAPPING =                             145,    /* see card property SUB_IMAGE_MAPPING_OUTPUT */
    SUB_IMAGE_MAPPING_OUTPUT =                      SUB_IMAGE_MAPPING,  /* Only has an effect on 4k/UHD and larger buffers. Use ESubImageMapping enum to specify value; default value is IMAGE_MAPPING_AUTO. To explicitely set a mode set either to IMAGE_MAPPING_TWO_SAMPLE_INTERLEAVE or IMAGE_MAPPING_SQUARE_DIVISION */
    SUB_IMAGE_MAPPING_INPUT =                       146,                /* Only has an effect on 4k/UHD and larger buffers. Use ESubImageMapping enum to specify value; default value is IMAGE_MAPPING_AUTO. To explicitely set a mode set either to IMAGE_MAPPING_TWO_SAMPLE_INTERLEAVE or IMAGE_MAPPING_SQUARE_DIVISION */
    ENABLE_NATIVE_UHD_INPUT =                       147,    /* KRONOS and above: 32 bit value; query and set. If set this enable native UHD input support via quad link (combining multiple SDI inputs into a native UHD buffer; otherwise (default) input streams will be handled as independent streams */
    DEVICE_NUMA_NODE =                              148,    /* 32 bit value, query only. Retreives the devices NUMA node. */
    SPG_CONTROL =                                   149,    /* 32 bit value; query/set; query will return a valid VID_FMT_EXT_* if enabled, zero if copying ExtRefIn signal. Set: Enable by writing valid VID_FMT_EXT_* to this card property; disable (= copy ExtRefIn) by writing zero. */
    COLORIMETRY_INPUT =                             150,
    COLORIMETRY_OUTPUT =                            151,
    EXTERNAL_LTC_INPUT =                            152,    /* 64 bit card property; this property retrieves the current incoming external LTC timecode;  */
    EPOCH_RESET_VIDEO_OUTPUT_FIELDCOUNT =           153,    /* 32 bit card property; use this property to reset the field count on the current output channel. You can pass the value that should be used as the starting fieldcount after the reset.
                                                             This property can be used to keep track of sync between multiple linked output channels */
    CARD_STANDBY_MODE =                             154,    /* 32 bit value: 0 = disable, 1 = enable; Kronos only; the card can be set into a low(er) power mode; no application should be running when enabling it. */
    TRANSFER_FUNCTION_OUTPUT =                      155,
    COLOR_DIFF_SIGNAL_OUTPUT =                      156,
...
typedef enum _ESubImageMapping
{
    ...
    IMAGE_MAPPING_AUTO =                    3,
}ESubImageMapping;

typedef enum _EBlueConversionType
{
    BLUE_CONVERSION_TYPE_NONE =         0,
    BLUE_CONVERSION_TYPE_2SI_TO_SQD =   1
}EBlueConversionType;
...
typedef enum _EVideoModeExt
{
    ...
    /* NON-STD UHD modes; only available by creating/setting registry key AllowNonStdUhdModes */
    VID_FMT_EXT_2160I_5000 =        1114, /* NON-STD UHD mode */
    VID_FMT_EXT_2160I_5994 =        1115, /* NON-STD UHD mode */
    VID_FMT_EXT_2160I_6000 =        1116, /* NON-STD UHD mode */
    VID_FMT_EXT_2160PSF_2398 =      1117, /* NON-STD UHD mode */
    VID_FMT_EXT_2160PSF_2400 =      1118, /* NON-STD UHD mode */
    VID_FMT_EXT_2160PSF_2500 =      1119, /* NON-STD UHD mode */
    VID_FMT_EXT_2160PSF_2997 =      1120, /* NON-STD UHD mode */
    VID_FMT_EXT_2160PSF_3000 =      1121, /* NON-STD UHD mode */
    VID_FMT_EXT_4K_2160PSF_2398 =   1122, /* NON-STD UHD mode */
    VID_FMT_EXT_4K_2160PSF_2400 =   1123, /* NON-STD UHD mode */
    VID_FMT_EXT_4K_2160PSF_2500 =   1124, /* NON-STD UHD mode */
    VID_FMT_EXT_4K_2160PSF_2997 =   1125, /* NON-STD UHD mode */
    VID_FMT_EXT_4K_2160PSF_3000 =   1126, /* NON-STD UHD mode */
    VID_FMT_EXT_LAST_ENTRY_V2 =     VID_FMT_EXT_4K_2160PSF_3000,
...
typedef enum _EEngineMode
{
    ...
    VIDEO_ENGINE_PLAYBACK =         1,  /* same as VIDEO_ENGINE_DUPLEX, FIFO mode */
    ...
    // new modes and aliases
    VIDEO_ENGINE_FIFO =                         VIDEO_ENGINE_DUPLEX,
    VIDEO_ENGINE_FIFO_CAPTURE_PLAYTHROUGH =     VIDEO_ENGINE_CAPTURE, /* set VIDEO_ENGINE card property and not VIDEO_INTPUT_ENGINE; uses an input and an output channel */
    VIDEO_ENGINE_AUTO_CAPTURE =                 6, /* new FIFO capture mode with lower latency and pinned memory usage; up to and including all HD/2K modes */
    VIDEO_ENGINE_AUTO_CAPTURE_UHD =             7, /* same as VIDEO_ENGINE_AUTO_CAPTURE but for UHD modes */
    VIDEO_ENGINE_AUTO_CAPTURE_PLAYTHROUGH =     8, /* same as VIDEO_ENGINE_AUTO_CAPTURE but with playthrough to output */
    VIDEO_ENGINE_AUTO_CAPTURE_UHD_PLAYTHROUGH = 9, /* same as VIDEO_ENGINE_AUTO_CAPTURE_UHD but with playthrough to output */
} EEngineMode;
...
typedef enum _ECardType
{
    ...
    CRD_BLUE_KRONOS_OPTIKOS_3G =    CRD_BLUE_KRONOS_OPTIKOS,
...
typedef enum _EEpochFirmwareProductID
{
    ORAC_FILMPOST_FIRMWARE_PRODUCTID =                                  (0x01), /* Epoch (2K) Horizon/Core/Ultra, Create/Create3D/Create3D Ultra, deprecated */
    ORAC_BROADCAST_FIRMWARE_PRODUCTID =                                 (0x02), /* Epoch (2K) Horizon/Core/Ultra, Create/Create3D/Create3D Ultra, deprecated */
    ORAC_ASI_FIRMWARE_PRODUCTID =                                       (0x03), /* Epoch (2K) Horizon/Core/Ultra, deprecated */
    ...
    ORAC_INPUT_1SDI_1CHANNEL_OUTPUT_4SDI_3CHANNEL_FIRMWARE_PRODUCTID =  (0x09), /* Epoch Supernova/Supernova S+, deprecated */
    ...
    ORAC_BNC_ASI_FIRMWARE_PRODUCTID =                                   (0x0C), /* Epoch Supernova/Supernova S+, deprecated */
    ORAC_NEUTRON_2_IN_0_OUT_FIRMWARE_PRODUCTID =                        (0x0D), /* Epoch Neutron, deprecated */
    ORAC_NEUTRON_0_IN_2_OUT_FIRMWARE_PRODUCTID =                        (0x0E), /* Epoch Neutron, deprecated */
    ORAC_NEUTRON_1_IN_1_OUT_FIRMWARE_PRODUCTID =                        (0x0F), /* Epoch Neutron, deprecated */
    ORAC_NEUTRON_2_IN_0_OUT_SCALER_FIRMWARE_PRODUCTID =                 (0x10), /* Epoch Neutron, deprecated */
    ORAC_NEUTRON_0_IN_2_OUT_SCALER_FIRMWARE_PRODUCTID =                 (0x11), /* Epoch Neutron, deprecated */
    ORAC_NEUTRON_1_IN_1_OUT_SCALER_FIRMWARE_PRODUCTID =                 (0x12), /* Epoch Neutron, deprecated */
    ORAC_NEUTRON_ASI_FIRMWARE_PRODUCTID =                               (0x13), /* Epoch Neutron */
    ORAC_INPUT_1SDI_1CHANNEL_OUTPUT_3SDI_3CHANNEL_FIRMWARE_PRODUCTID =  (0x14), /* Epoch Supernova/Supernova S+, deprecated */
    ...
    ORAC_INPUT_1SDI_1CHANNEL_OUTPUT_3SDI_2CHANNEL_FIRMWARE_PRODUCTID =  (0x18), /* Epoch Supernova/Supernova S+, keyer support */
    ORAC_NEUTRON_2_IN_1_OUT_FIRMWARE_PRODUCTID =                        (0x19), /* Epoch Neutron */
    ZEUS_4_IN_4_OUT_FIRMWARE_PRODUCTID =                                (0x1A), /* Kronos Elektron/K8/Optikos3G, version <= v1.4.x */
    ZEUS_8_IN_FIRMWARE_PRODUCTID =                                      (0x1B), /* Kronos Elektron/K8/Optikos3G, version <= v1.4.x */
    ZEUS_8_OUT_FIRMWARE_PRODUCTID =                                     (0x1C), /* Kronos Elektron/K8/Optikos3G, version <= v1.4.x */
    ZEUS_RECOVERY_FIRMWARE_PRODUCTID =                                  (0x1D), /* Kronos Elektron/K8/Optikos3G */
    ZEUS_4_IN_4_OUT_DVE_FIRMWARE_PRODUCTID =                            (0x1E), /* Kronos Elektron/K8/Optikos3G, version <= v1.4.x */
    ZEUS_BNC_4_IN_4_OUT_FIRMWARE_PRODUCTID =                            (0x1F), /* Kronos Elektron/K8, version >= 1.5.x */
    ZEUS_BNC_8_IN_FIRMWARE_PRODUCTID =                                  (0x20), /* Kronos Elektron/K8, version >= 1.5.x */
    ZEUS_BNC_8_OUT_FIRMWARE_PRODUCTID =                                 (0x21), /* Kronos Elektron/K8, version >= 1.5.x */
    ZEUS_SFP_4_IN_4_OUT_FIRMWARE_PRODUCTID =                            (0x22), /* Kronos Optikos3G, version >= 1.5.x */
    ZEUS_SFP_8_IN_FIRMWARE_PRODUCTID =                                  (0x23), /* Kronos Optikos3G, version >= 1.5.x */
    ZEUS_SFP_8_OUT_FIRMWARE_PRODUCTID =                                 (0x24), /* Kronos Optikos3G, version >= 1.5.x */
    ZEUS_BNC_6_IN_2_OUT_FIRMWARE_PRODUCTID =                            (0x25), /* Kronos Elektron/K8, version >= 1.5.x */
    ZEUS_BNC_2_IN_6_OUT_FIRMWARE_PRODUCTID =                            (0x26), /* Kronos Elektron/K8, version >= 1.5.x */
    ZEUS_SFP_6_IN_2_OUT_FIRMWARE_PRODUCTID =                            (0x27), /* Kronos Optikos3G, version >= 1.5.x */
    ZEUS_SFP_2_IN_6_OUT_FIRMWARE_PRODUCTID =                            (0x28), /* Kronos Optikos3G, version >= 1.5.x */

}EEpochFirmwareProductID;
...
{
    BLUE_VIDEO_OUTPUT_CHANNEL_1 =  0,
    BLUE_VIDEO_OUTPUT_CHANNEL_2 =  1,
    BLUE_VIDEO_INPUT_CHANNEL_1 =   2,
    BLUE_VIDEO_INPUT_CHANNEL_2 =   3,
    BLUE_VIDEO_INPUT_CHANNEL_3 =   4,
    BLUE_VIDEO_INPUT_CHANNEL_4 =   5,
    BLUE_VIDEO_OUTPUT_CHANNEL_3 =  6,
    BLUE_VIDEO_OUTPUT_CHANNEL_4 =  7,
    BLUE_VIDEO_OUTPUT_CHANNEL_5 =  8,
    BLUE_VIDEO_OUTPUT_CHANNEL_6 =  9,
    BLUE_VIDEO_OUTPUT_CHANNEL_7 = 10,
    BLUE_VIDEO_OUTPUT_CHANNEL_8 = 11,
    BLUE_VIDEO_INPUT_CHANNEL_5 =  12,
    BLUE_VIDEO_INPUT_CHANNEL_6 =  13,
    BLUE_VIDEO_INPUT_CHANNEL_7 =  14,
    BLUE_VIDEO_INPUT_CHANNEL_8 =  15,

    BLUE_VIDEO_INPUT_CHANNEL_A = BLUE_VIDEO_INPUT_CHANNEL_1,
    BLUE_VIDEO_INPUT_CHANNEL_B = BLUE_VIDEO_INPUT_CHANNEL_2,
    BLUE_VIDEO_INPUT_CHANNEL_C = BLUE_VIDEO_INPUT_CHANNEL_3,
    BLUE_VIDEO_INPUT_CHANNEL_D = BLUE_VIDEO_INPUT_CHANNEL_4,
    BLUE_VIDEO_INPUT_CHANNEL_E = BLUE_VIDEO_INPUT_CHANNEL_5,
    BLUE_VIDEO_INPUT_CHANNEL_F = BLUE_VIDEO_INPUT_CHANNEL_6,
    BLUE_VIDEO_INPUT_CHANNEL_G = BLUE_VIDEO_INPUT_CHANNEL_7,
    BLUE_VIDEO_INPUT_CHANNEL_H = BLUE_VIDEO_INPUT_CHANNEL_8,

    BLUE_VIDEO_OUTPUT_CHANNEL_A = BLUE_VIDEO_OUTPUT_CHANNEL_1,
    BLUE_VIDEO_OUTPUT_CHANNEL_B = BLUE_VIDEO_OUTPUT_CHANNEL_2,
    BLUE_VIDEO_OUTPUT_CHANNEL_C = BLUE_VIDEO_OUTPUT_CHANNEL_3,
    BLUE_VIDEO_OUTPUT_CHANNEL_D = BLUE_VIDEO_OUTPUT_CHANNEL_4,
    BLUE_VIDEO_OUTPUT_CHANNEL_E = BLUE_VIDEO_OUTPUT_CHANNEL_5,
    BLUE_VIDEO_OUTPUT_CHANNEL_F = BLUE_VIDEO_OUTPUT_CHANNEL_6,
    BLUE_VIDEO_OUTPUT_CHANNEL_G = BLUE_VIDEO_OUTPUT_CHANNEL_7,
    BLUE_VIDEO_OUTPUT_CHANNEL_H = BLUE_VIDEO_OUTPUT_CHANNEL_8,

    BLUE_VIDEOCHANNEL_INVALID = 30,

    // deprecated aliases, don't use
    BLUE_VIDEOCHANNEL_A = BLUE_VIDEO_OUTPUT_CHANNEL_A,
    BLUE_VIDEOCHANNEL_B = BLUE_VIDEO_OUTPUT_CHANNEL_B,
    BLUE_VIDEOCHANNEL_C = BLUE_VIDEO_INPUT_CHANNEL_A,
    BLUE_VIDEOCHANNEL_D = BLUE_VIDEO_INPUT_CHANNEL_B,
    BLUE_VIDEOCHANNEL_E = BLUE_VIDEO_INPUT_CHANNEL_C,
    BLUE_VIDEOCHANNEL_F = BLUE_VIDEO_INPUT_CHANNEL_D,
    BLUE_VIDEOCHANNEL_G = BLUE_VIDEO_OUTPUT_CHANNEL_C,
    BLUE_VIDEOCHANNEL_H = BLUE_VIDEO_OUTPUT_CHANNEL_D,
    BLUE_VIDEOCHANNEL_I = BLUE_VIDEO_OUTPUT_CHANNEL_E,
    BLUE_VIDEOCHANNEL_J = BLUE_VIDEO_OUTPUT_CHANNEL_F,
    BLUE_VIDEOCHANNEL_K = BLUE_VIDEO_OUTPUT_CHANNEL_G,
    BLUE_VIDEOCHANNEL_L = BLUE_VIDEO_OUTPUT_CHANNEL_H,
    BLUE_VIDEOCHANNEL_M = BLUE_VIDEO_INPUT_CHANNEL_E,
    BLUE_VIDEOCHANNEL_N = BLUE_VIDEO_INPUT_CHANNEL_F,
    BLUE_VIDEOCHANNEL_O = BLUE_VIDEO_INPUT_CHANNEL_G,
    BLUE_VIDEOCHANNEL_P = BLUE_VIDEO_INPUT_CHANNEL_H,

}EBlueVideoChannel;

typedef enum _EEpochRoutingElements
{
    MR2_NODE_INVALID =                      0x0,
...
typedef enum _EPreDefinedColorSpaceMatrix
{
    ...
    MATRIX_RGB_TO_YUV_REC2020_CGR =     14,
    MATRIX_RGB_TO_YUV_REC2020_SMPTE =   15,
    MATRIX_YUV_TO_RGB_REC2020_CGR =     16,
    MATRIX_YUV_TO_RGB_REC2020_SMPTE =   17,

    // aliases
    MATRIX_RGB_TO_YUV_709 =             MATRIX_709, 
    MATRIX_RGB_TO_YUV_709_SMPTE =       MATRIX_709,
    MATRIX_RGB_TO_YUV_709_CGR =         MATRIX_709_CGR,
    MATRIX_RGB_TO_YUV_601 =             MATRIX_601,
    MATRIX_RGB_TO_YUV_601_SMPTE =       MATRIX_601,
    MATRIX_RGB_TO_YUV_601_CGR =         MATRIX_601_CGR,
    MATRIX_YUV_TO_RGB_709_SMPTE =       MATRIX_YUV_TO_RGB_709,
    MATRIX_YUV_TO_RGB_601_SMPTE =       MATRIX_YUV_TO_RGB_601,

} EPreDefinedColorSpaceMatrix;

typedef enum ETransportColorimetry
{
    COLORIMETRY_INVALID =   0,
    COLORIMETRY_CUSTOM =    1, 
    COLORIMETRY_601 =       2,
    COLORIMETRY_709 =       3,
    COLORIMETRY_2020 =      4,

}ETransportColorimetry;

typedef enum ETransportTransferFunc
{
    TRANSFER_FUNC_INVALID =     0,
    TRANSFER_FUNC_SDR =         1,
    TRANSFER_FUNC_HLG =         2,
    TRANSFER_FUNC_PQ =          3,
    TRANSFER_FUNC_UNSPECIFIED = 4,
}ETransportTransferFunc;

typedef enum EBlueColorDiff
{
    COLOR_DIFF_INVALID = 0,
    COLOR_DIFF_YCBCR =   1,
    COLOR_DIFF_ICTCP =   2,
}EBlueColorDiff;
...
typedef enum _EDualLinkSignalFormatType
{
    ...
    Signal_FormatType_444_10BitSDI =    1,      /* sets the card to work in 4:4:4 10 bit dual link mode */
    Signal_FormatType_422 =             2,
    Signal_FormatType_444_12BitSDI =    4,      /* sets the card to work in 4:4:4 12 bit dual link mode */

    /* not used currently on epoch cards */
    Signal_FormatType_Key_Key =         0x8000,

    /* aliases; don't use */
    Signal_FormatType_4444 =            Signal_FormatType_444_10BitSDI,
    Signal_FormatType_Independent_422 = Signal_FormatType_422,
    

}EDualLinkSignalFormatType, ETransportSampling;
...
{
    SerialPort_Read =                       0x01,
    SerialPort_Write =                      0x02,
    SerialPort_TX_Queue_Status =            0x04,
    SerialPort_RX_Queue_Status =            0x08,
    SerialPort_RX_FlushBuffer =             0x10,
    SerialPort_RX_IntWait_Return_On_Data =  0x20,
};

/*  Use the following enum values for controlling the application watchdog timer settings through the card property EPOCH_APP_WATCHDOG_TIMER.
    Use the macro EPOCH_WATCHDOG_TIMER_SET_MACRO for setting up values to be passed in bfcSetCardProperty32().
    Use the macro EPOCH_WATCHDOG_TIMER_GET_VALUE_MACRO to decode a value returned from bfcQueryCardProperty32().
    See sample app BlueWatchdog for more info. */
typedef enum enum_blue_app_watchdog_timer_prop
{
    BLUE_APP_WATCHDOG_TIMER_ENABLE =                (1 << 31), /* set only, value = 0 = stop timer, value > 0 = timer value (number of interrupts (fields for interlaced signals) before watchdog triggers */
    BLUE_APP_WATCHDOG_TIMER_KEEP_ALIVE =            (1 << 30), /* set only, value = value to reset timer to */
    BLUE_APP_WATCHDOG_TIMER_GET_TIMER_VALUE =       (1 << 29), /* query only, returns current timer value */
    BLUE_APP_WATCHDOG_TIMER_GET_TRIGGER_STATUS =    (1 << 28), /* query only, returns if the watchdog has triggered (and turned on the bypass relays), 0 = not triggered, 1 = triggered */
    BLUE_APP_WATCHDOG_TIMER_GET_TIMER_STATUS =      (1 << 27), /* query only, returns if the watchdog timer is running, 0 = not running, 1 = running */
...
typedef enum
{
    AUDIO_CHANNEL_32BIT = 0x00000000,
    AUDIO_CHANNEL_16BIT = 0x00000008,
    AUDIO_CHANNEL_24BIT = 0x00000080
} EAudioFlags;

typedef enum EBlueSignalLinkType
{
    SIGNAL_LINK_TYPE_INVALID =                  0,
    SIGNAL_LINK_TYPE_SINGLE_LINK =              1,
    SIGNAL_LINK_TYPE_SINGLE_LINK_DUAL_STREAM =  2,
    SIGNAL_LINK_TYPE_DUAL_LINK =                3,
    SIGNAL_LINK_TYPE_QUAD_LINK =                4,
}EBlueSignalLinkType;

typedef enum EBlueBufferComponent
{
    BUFFER_COMPONENT_INVALID = 0x00000000,
    BUFFER_COMPONENT_VIDEO =   0x00000001,
    BUFFER_COMPONENT_VANC =    0x00000002,
    BUFFER_COMPONENT_HANC =    0x00000004,
}EBlueBufferComponent;

typedef enum EBlueReturnMode
{
    RETURN_MODE_INVALID =      0,
    RETURN_MODE_BLOCKING =     1, 
    RETURN_MODE_NON_BLOCKING = 2
}EBlueReturnMode;

typedef enum EBlueUhdPreference
{
    UHD_PREFERENCE_INVALID =            0, /* This is invalid. Passing this will return in an error from the function. */
    UHD_PREFERENCE_BASED_ON_VPID =      1, /* Only do UHD if the input VPID indicates a UHD mode and the signal information matches the VPID */
    UHD_PREFERENCE_DEFAULT =            UHD_PREFERENCE_BASED_ON_VPID,
    UHD_PREFERENCE_DO_UHD_IF_POSSIBLE = 2, /* Try and turn all possible HD modes into a UHD mode, if possible; i.e. PAL, 720P and interlaced HD modes will not be turned into UHD. All other 1080P modes will be treated as UHD */
    UHD_PREFERENCE_UHD_ONLY =           3, /* The returned setup will only return UHD modes, even if only a single link is available or the input mode is interlaced (SD and 720P modes will fail) */
    UHD_PREFERENCE_HD_ONLY =            4, /* When the source is UHD, but you want to access a single stream/link of that signal. Ignores the VPID if it says UHD */
}EBlueUhdPreference;
/*///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////// S T R U C T S ////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
...
struct blue_videoframe_info_ex
{
    ...
    unsigned long   Count;              /* number of available (captured) frames in FIFO that can be retrieved via bfcGetCaptureVideoFrameInfoEx() */
...
typedef struct blue_multi_link_info_struct
{
...
typedef struct sdi_connector_signal_info
{
    EBlueConnectorIdentifier ConnectorId;
    BLUE_U32 StreamCount;               // number of streams contained in signal on connector
    vpid_info VpidInfo[8];              // up to eight streams per connector at 12G
    BLUE_U32 Transport;                 // EHdSdiTransport
    BLUE_U32 ActivePixelsPerLine;
    BLUE_U32 BlankingPixelsPerLine;
    BLUE_U32 ActiveVideoLines;
    BLUE_U32 FrameRate;
    BLUE_U32 Flags;                     // bit 0: progressive, bit 1: frame rate is 1001
    BLUE_U32 VideoModeExt;
    BLUE_U32 Reserved2;
    BLUE_U32 Reserved1;
    BLUE_U32 Reserved0;
}sdi_connector_signal_info;

typedef struct blue_auto_buffer_info
{
    BLUE_VOID*          pBufferVideo;   /* points to host memory containing the video frame buffer */
    BLUE_VOID*          pBufferVanc;    /* points to host memory containing the VANC buffer; might be multiple VANC buffers from all virtual links, e.g. 3GB or 12G; */
    BLUE_VOID*          pBufferHanc;    /* points to host memory containing the HANC frame buffer; might be multiple HANC buffers from all virtual links, e.g. 3GB or 12G; */
    BLUE_U32            SizeVideo;
    BLUE_U32            SizeVanc;
    BLUE_U32            SizeHanc;
    BLUE_U32            FilledBufferCount;
    BLUE_U32            EmptyBufferCount;
    BLUE_U32            UserBufferCount;
    BLUE_U32            BufferIncomplete;   /* = BLUE_BUFFER_COMPLETE -> buffer complete, != BLUE_BUFFER_COMPLETE -> buffer missing data*/
    BLUE_U32            UniqueFrameId;      /* since start of capture; reset when calling bfcVideoCaptureStart() */
    BLUE_U32            FieldCount;
    BLUE_U32            DroppedFrameCount;
    BLUE_U64            BtcTimeStamps[4];   /* timestamps for the HD stream (BtcTimeStamps[0]) or all quadrants in a UHD stream */
    BLUE_U64            Timecodes[4];       /* RP188 VITC, RP188 LTC, SD VITC, external LTC; just like in Bluefish HANC buffer */
    BLUE_S32            CardBufferId;
    BLUE_S32            PinnedBufferIndex;
    EVideoModeExt       VideoModeExt;
    EMemoryFormat       VideoPixelFormat;
    EUpdateMethod       VideoUpdateFormat;
    BLUE_S32            VideoWidth;
    BLUE_S32            VideoHeight;
    EHdSdiTransport     TransportType;
    EBlueConversionType RequiredConversionType; /* For UHD when input signal is 2SI a conversion of this buffer might be required */
    BLUE_U32            VideoChunkIndex; 
    BLUE_U32            VideoStartLine;       /* Used when in "chunk" mode */
    BLUE_U32            Reserved[19];
}blue_auto_buffer_info;

typedef struct blue_device_info
{
    hardware_firmware_versions HwFwVersions;
    BLUE_S32                   CardType;
    BLUE_S8                    CardSerialNumber[32];
    BLUE_S8                    PCBSerialNumber[32];
    BLUE_U32                   FirmwareType;
    BLUE_U32                   SdiConnectorCountInput;
    BLUE_U32                   SdiConnectorCountOutput;
    BLUE_U32                   AESConnectorCount;
    BLUE_U32                   RS422ConnectorCount;
    BLUE_U32                   LTCConnectorCount;
    BLUE_U32                   GPIOConnectorCount;
    BLUE_U32                   HDMIConnectorCountInput;
    BLUE_U32                   HDMIConnectorCountOutput;
    BLUE_U32                   SdiStreamCountInput;
    BLUE_U32                   SdiStreamCountOutput;
    BLUE_U32                   AsiStreamCountInput;
    BLUE_U32                   AsiStreamCountOutput;
    BLUE_U32                   Supports3G;
    BLUE_U32                   Supports6G;
    BLUE_U32                   Supports12G;
    BLUE_U32                   Reserved[8];
}blue_device_info;

typedef struct blue_setup_info
{
    BLUE_S32                    DeviceId;
    EBlueVideoChannel           VideoChannelInput;      /* used for input setup only */
    EBlueVideoChannel           VideoChannelOutput;     /* used for output setup; also used for input setup when doing playthrough */
    EVideoModeExt               VideoModeExt;           /* set to valid video mode for output setup; will return current video mode for input setup */
    EBlueSignalLinkType         SignalLinkType;         /* single link / single link-dual stream / dual link / quad link */
    EUpdateMethod               UpdateMethod;           /* field (interlaced modes only) vs frame (interlaced and progressive modes)*/
    EMemoryFormat               MemoryFormat;
    ERGBDataRange               MemoryFormatDataRange;  /* SMPTE (Video) vs CGR (Full) range */
    EEngineMode                 VideoEngine;
    ETransportSampling          TransportSampling;      /* 422, 4224, 4444; 10/12 bit */
    EConnectorSignalColorSpace  TransportColorSpace;    /* RGB (4444 only) vs YUV(422, 4224 only) */
    ETransportColorimetry       TransportColorimetry;   /* 601 (SD), 709 (HD), 2020 (UHD), etc */
    EHdSdiTransport             Transport;              /* 1.5G, 3GA, 3GB, 6G, 12G */
    ESubImageMapping            VideoSubImageMapping;   /* UHD only: 2SI vs SQD */
    ETransportTransferFunc      TransferFunc;           /* Indicative only; when using any value other than TRANSFER_FUNC_SDR only 10/16 bit YUV pixel formats are supported */
    EBlueColorDiff              ColorDiff;
    BLUE_S32                    Reserved[8];
}blue_setup_info;
