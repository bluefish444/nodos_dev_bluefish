...
#ifndef FLATBUFFERS_GENERATED_BLUEFISHTYPES_NOS_BLUEFISH_H_
#define FLATBUFFERS_GENERATED_BLUEFISHTYPES_NOS_BLUEFISH_H_
...
struct DeviceId::Traits {
  ...
  static constexpr auto fully_qualified_name = "nos.bluefish.DeviceId";
...
inline ::flatbuffers::Offset<DeviceId> CreateDeviceIdDirect(
  ...
  return nos::bluefish::CreateDeviceId(
      _fbb,
      serial__,
      name__);
}
...
struct TChannelId : public ::flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR_CPP11 const char *GetFullyQualifiedName() {
    return "nos.bluefish.TChannelId";
  }
  int32_t id = 0;
  std::string name{};
};
...
struct ChannelId::Traits {
  ...
  static constexpr auto fully_qualified_name = "nos.bluefish.ChannelId";
  static constexpr size_t fields_number = 2;
  static constexpr std::array<const char *, fields_number> field_names = {
    "id",
    "name"
...
inline ::flatbuffers::Offset<ChannelId> CreateChannelIdDirect(
    ...
    const char *name = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  return nos::bluefish::CreateChannelId(
      _fbb,
      id,
      name__);
}
...
struct TChannelInfo : public ::flatbuffers::NativeTable {
  ...
  static FLATBUFFERS_CONSTEXPR_CPP11 const char *GetFullyQualifiedName() {
    return "nos.bluefish.TChannelInfo";
  }
  std::unique_ptr<nos::bluefish::TDeviceId> device{};
...
struct ChannelInfo FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  static FLATBUFFERS_CONSTEXPR_CPP11 const char *GetFullyQualifiedName() {
    return "nos.bluefish.ChannelInfo";
  }
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_DEVICE = 4,
    VT_CHANNEL = 6,
  ...
  nos::bluefish::DeviceId *mutable_device() {
    return GetPointer<nos::bluefish::DeviceId *>(VT_DEVICE);
  }
  const nos::bluefish::ChannelId *channel() const {
    return GetPointer<const nos::bluefish::ChannelId *>(VT_CHANNEL);
  }
  nos::bluefish::ChannelId *mutable_channel() {
    return GetPointer<nos::bluefish::ChannelId *>(VT_CHANNEL);
  }
...
struct ChannelInfoBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_device(::flatbuffers::Offset<nos::bluefish::DeviceId> device) {
    fbb_.AddOffset(ChannelInfo::VT_DEVICE, device);
  }
  void add_channel(::flatbuffers::Offset<nos::bluefish::ChannelId> channel) {
...
inline void ChannelInfo::UnPackTo(TChannelInfo *_o, const ::flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = device(); if (_e) { if(_o->device) { _e->UnPackTo(_o->device.get(), _resolver); } else { _o->device = std::unique_ptr<nos::bluefish::TDeviceId>(_e->UnPack(_resolver)); } } else if (_o->device) { _o->device.reset(); } }
...
#endif  // FLATBUFFERS_GENERATED_BLUEFISHTYPES_NOS_BLUEFISH_H_
